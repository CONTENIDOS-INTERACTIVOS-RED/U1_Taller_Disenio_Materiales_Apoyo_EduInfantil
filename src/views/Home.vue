        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde el ámbito educativo, la planificación y el diseño de materiales didácticos son herramientas esenciales para potenciar el aprendizaje en la primera infancia. En esta unidad, se explorarán las secuencias didácticas y los materiales didácticos, comprendiendo su relación y aplicabilidad en la enseñanza. Se analizarán los principios fundamentales que guían la creación de recursos educativos, enfatizando la importancia del orden, la jerarquía en el aprendizaje y el desarrollo de experiencias significativas para los niños y niñas.
              
              p #[b ¡Prepárese para diseñar materiales innovadores que transformen la experiencia de aprendizaje infantil!]
